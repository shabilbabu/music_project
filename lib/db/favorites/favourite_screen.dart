    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ValueListenableBuilder(
          valueListenable: FavouriteData.favouritesong,
                  ...
                  onTap: () {
                    HomeScreen.player.setAudioSource(
                        Concatinating.createPlaylist(
                            FavouriteData.favsongmodellist),
                        initialIndex: index);
                    HomeScreen.player.play();

                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => PlayScreen(
                              pattu: FavouriteData.favsongmodellist,
                            )));
                  },
                  title: Text(
                    HomeScreen.songs[value[index]].title,
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: const TextStyle(color: Colors.white),
                  ),
                  subtitle: Text(
                    HomeScreen.songs[value[index]].artist.toString(),
                    style: const TextStyle(color: Color.fromARGB(255, 207, 207, 207)),
                  ),
                  // trailing:  FavouritButton(index: index),
                  leading: QueryArtworkWidget(
                      id: HomeScreen.songs[value[index]].id,
                                ...
                                content: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      TextButton(
                                        onPressed: () {
                                          FavouriteData.removelist(index);
                                          Navigator.pop(context);
                                        },
                                        child: const Text(
                                          'Ok',
