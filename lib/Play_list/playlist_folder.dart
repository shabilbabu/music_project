...
class PlaylistFolder extends StatefulWidget {
 const PlaylistFolder({Key? key, required this.folderindex}) : super(key: key);
...
class _PlaylistFolderState extends State<PlaylistFolder> {
  ...
  Widget build(BuildContext context) {
    PlaylistFolder.updatelist=PlayFunction.idees[widget.folderindex];
    PlayFunction.displayplaylist();
    songCheckPlaylist.showselectedsong(widget.folderindex);
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              Text(
                PlayFunction.listplaysong.value[widget.folderindex].name
                    .toString(),
                    maxLines: 1,
                            ...
                            children: <Widget>[
                              Align(
                                ...
                                child: IconButton(onPressed: () {
                                  final model=MusicModel(name:  PlayFunction.listplaysong.value[widget.folderindex].name,songlistdb: PlaylistFolder.updatelist);
                                  PlayFunction.updatePlaylist(widget.folderindex, model);
                                  ...
                                  child: ListView.separated(
                                      ...
                                      itemBuilder:
                                        ...
                                        return ListTile(
                                          ...
                                          trailing: UpdateAddRemoveButton(index: index), 
                                          leading: ClipRRect(
          ...
          builder: (BuildContext context, dynamic value, Widget? child) {
            return ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return ListTile(
                      onTap: () {
                        HomeScreen.player.setAudioSource(
                            Concatinating.createPlaylist(
                                PlayFunction.playlistsongmodel),
                            initialIndex: index);
                        HomeScreen.player.play();

                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => PlayScreen(
                                  pattu: PlayFunction.playlistsongmodel,
                                )));
                      },
                      title: Text(
                        HomeScreen
